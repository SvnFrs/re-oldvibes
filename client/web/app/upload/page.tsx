...
function MediaPreview({ file, onRemove }: { file: File; onRemove: () => void }) {
  ...
  return (
    <div className="relative w-24 h-24 rounded-lg overflow-hidden bg-gruvbox-gray/20">
      ...
      <button
        onClick={onRemove}
        className="absolute -top-2 -right-2 w-6 h-6 bg-gruvbox-red text-gruvbox-light-bg0 rounded-full flex items-center justify-center hover:bg-gruvbox-red/80 transition-colors"
      >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gruvbox-light-bg1 dark:bg-gruvbox-dark-bg1 border border-gruvbox-gray/20 rounded-lg focus:ring-2 focus:ring-gruvbox-yellow/50 focus:border-transparent text-gruvbox-light-fg0 dark:text-gruvbox-dark-fg0"
                      placeholder="500000"
                      min="0"
                      required
                    />
