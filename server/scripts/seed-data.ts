...
const sampleEmails = sampleUsernames.map(
...
const sampleItems = [
  // Electronics
  {
    ...
    description:
      "Điện thoại iPhone 13 Pro Max 128GB, còn bảo hành 8 tháng, máy đẹp như mới",
  ...
  },
  {
    ...
    description: "Điện thoại Samsung Galaxy S22 256GB, màu đen, máy đẹp",
    category: "Electronics",
    price: 16500000,
  ...
  },
  {
    ...
    description: "Máy tính bảng iPad Pro 11 inch 128GB, kèm bút Apple Pencil",
    category: "Electronics",
    price: 19500000,
  ...
  {
    name: "AirPods Pro 2",
    description: "Tai nghe AirPods Pro thế hệ 2, chống ồn chủ động",
    category: "Electronics",
    price: 5500000,
    tags: ["airpods", "apple", "headphone"],
  },
  ...
  // Fashion
  {
    ...
    description:
      "Áo khoác jean nam size L, màu xanh đậm, chất liệu cotton cao cấp",
    category: "Fashion",
    price: 450000,
  ...
  {
    name: "Váy liền nữ",
    description: "Váy liền nữ size M, màu đen, thiết kế sang trọng",
    category: "Fashion",
    price: 380000,
    tags: ["váy", "nữ", "công sở"],
  },
  {
    ...
    description: "Giày sneaker Adidas size 42, màu trắng, còn mới 90%",
    category: "Fashion",
    price: 850000,
    tags: ["giày", "sneaker", "adidas"],
  },
  {
    name: "Túi xách nữ da",
    description: "Túi xách nữ da bò thật, màu nâu, thiết kế vintage",
    category: "Fashion",
    price: 1200000,
    tags: ["túi xách", "da", "nữ"],
  },
  {
    name: "Đồng hồ nam Rolex",
    description: "Đồng hồ nam Rolex Datejust, máy cơ, dây da",
    category: "Fashion",
    price: 85000000,
    tags: ["đồng hồ", "rolex", "luxury"],
  },
  ...
  },
  {
    ...
    description: "Bộ truyện tranh One Piece tập 1-50, bản tiếng Nhật",
    category: "Books",
    price: 250000,
    tags: ["manga", "one piece", "truyện tranh"],
  },
  {
    name: "Sách học tiếng Anh",
    description: "Sách học tiếng Anh TOEIC, kèm CD, sách mới 100%",
    category: "Books",
    price: 120000,
    tags: ["sách", "tiếng anh", "toeic"],
  },
  {
    name: "Từ điển Anh-Việt",
    description: "Từ điển Anh-Việt Oxford, bản mới nhất, sách còn mới",
    category: "Books",
    price: 180000,
    tags: ["từ điển", "anh-việt", "oxford"],
  },
  {
    name: "Sách nấu ăn",
    description: "Sách dạy nấu ăn món Việt Nam, nhiều hình ảnh minh họa",
    category: "Books",
    price: 95000,
    tags: ["sách", "nấu ăn", "ẩm thực"],
  },

  // Toys
  {
    name: "Lego Creator",
    description: "Bộ lắp ráp Lego Creator, 1000 mảnh, dành cho trẻ em 8+",
    category: "Toys",
    price: 850000,
    tags: ["lego", "lắp ráp", "trẻ em"],
  },
  {
    name: "Xe điều khiển từ xa",
    description: "Xe ô tô điều khiển từ xa, pin sạc, tốc độ cao",
    category: "Toys",
    price: 450000,
    tags: ["xe", "điều khiển", "từ xa"],
  },
  {
    name: "Búp bê Barbie",
    description: "Búp bê Barbie có nhiều phụ kiện, đồ chơi mới",
    category: "Toys",
    price: 320000,
    tags: ["búp bê", "barbie", "trẻ em"],
  },
  {
    name: "Bộ cờ vua",
    description: "Bộ cờ vua gỗ cao cấp, quân cờ điêu khắc đẹp",
    category: "Toys",
    price: 180000,
    tags: ["cờ vua", "gỗ", "trò chơi"],
  },
  {
    name: "Puzzle 1000 mảnh",
    description: "Bộ ghép hình puzzle 1000 mảnh, hình phong cảnh",
    category: "Toys",
    price: 120000,
    tags: ["puzzle", "ghép hình", "1000 mảnh"],
  },
  ...
  {
    name: "Ghế sofa 3 chỗ",
    description: "Ghế sofa 3 chỗ ngồi, vải bố, màu xám, còn mới 95%",
    category: "Home",
    price: 2500000,
    tags: ["sofa", "ghế", "phòng khách"],
  },
  {
    ...
    category: "Home",
    price: 8500000,
    tags: ["tủ lạnh", "samsung", "inverter"],
  },
  {
    name: "Máy lọc nước",
    description: "Máy lọc nước RO 7 cấp, lõi lọc còn mới",
    category: "Home",
    price: 1800000,
    tags: ["máy lọc", "nước", "ro"],
  },
  {
    name: "Bình nước nóng",
    description: "Bình nước nóng Ariston 15L, tiết kiệm điện",
    category: "Home",
    price: 1200000,
    tags: ["bình nước nóng", "ariston", "15L"],
  },
  ...
  {
    name: "Gậy golf bộ",
    description: "Bộ gậy golf 14 gậy, thương hiệu Callaway, còn mới",
    category: "Sports",
    price: 15000000,
    tags: ["golf", "gậy", "callaway"],
  },
  {
    name: "Giày chạy bộ Nike",
    description: "Giày chạy bộ Nike Air Max, size 42, màu đen trắng",
    category: "Sports",
    price: 1200000,
    tags: ["giày", "chạy bộ", "nike"],
  },
  {
    name: "Vợt tennis Wilson",
    description: "Vợt tennis Wilson Pro Staff, còn mới 95%",
    category: "Sports",
    price: 850000,
    tags: ["vợt", "tennis", "wilson"],
  },
  {
    name: "Bóng đá Adidas",
    description: "Bóng đá Adidas Champions League, size 5",
    category: "Sports",
    price: 450000,
    tags: ["bóng đá", "adidas", "champions league"],
  },

  // Beauty
  {
    name: "Son MAC Ruby Woo",
    description: "Son MAC Ruby Woo, màu đỏ classic, còn mới 90%",
    category: "Beauty",
    price: 380000,
    tags: ["son", "mac", "ruby woo"],
  },
  {
    name: "Kem dưỡng ẩm La Mer",
    description: "Kem dưỡng ẩm La Mer 30ml, hàng chính hãng",
    category: "Beauty",
    price: 2800000,
    tags: ["kem dưỡng", "la mer", "luxury"],
  },
  {
    name: "Nước hoa Chanel No.5",
    description: "Nước hoa Chanel No.5 50ml, hàng chính hãng",
    category: "Beauty",
    price: 2200000,
    tags: ["nước hoa", "chanel", "no.5"],
  },
  {
    name: "Mặt nạ đất sét",
    description: "Mặt nạ đất sét Innisfree, 100ml, còn mới",
    category: "Beauty",
    price: 180000,
    tags: ["mặt nạ", "đất sét", "innisfree"],
  },
  {
    name: "Serum vitamin C",
    description: "Serum vitamin C The Ordinary, 30ml, hàng chính hãng",
    category: "Beauty",
    price: 280000,
    tags: ["serum", "vitamin c", "the ordinary"],
  },

  // Other
  {
    name: "Máy ảnh Canon",
    description: "Máy ảnh Canon EOS 200D, kèm ống kính 18-55mm",
    category: "Other",
    price: 8500000,
    tags: ["máy ảnh", "canon", "eos"],
  },
  {
    name: "Đàn guitar acoustic",
    description: "Đàn guitar acoustic Yamaha, gỗ cây thông, âm thanh hay",
    category: "Other",
    price: 3200000,
    tags: ["đàn guitar", "acoustic", "yamaha"],
  },
  {
    name: "Đồng hồ thông minh",
    description: "Đồng hồ thông minh Apple Watch Series 7, GPS",
    category: "Other",
    price: 6500000,
    tags: ["apple watch", "thông minh", "gps"],
  },
  {
    name: "Máy massage",
    description: "Máy massage cầm tay, nhiều chế độ, pin sạc",
    category: "Other",
    price: 450000,
    tags: ["máy massage", "cầm tay", "sạc"],
  },
  {
    name: "Thảm yoga",
    description: "Thảm yoga cao cấp, chống trượt, dày 6mm",
    category: "Other",
    price: 280000,
    tags: ["thảm yoga", "chống trượt", "6mm"],
  },
];
...
async function connectDB() {
  try {
    ...
    console.log("CHECK MONGO URI: ", mongoUri);
  ...
  for (let i = 0; i < sampleItems.length * 3; i++) {
    ...
    for (let j = 0; j < mediaCount; j++) {
      mediaFiles.push({
        type: "image" as const,
        url: sampleImageUrls[
          Math.floor(Math.random() * sampleImageUrls.length)
        ],
      });
    }
  ...
  for (const vibe of vibes) {
    ...
    for (let i = 0; i < commentCount; i++) {
      ...
      const comment = new Comment({
        ...
        likes: [],
        createdAt: new Date(
          vibe.createdAt.getTime() +
            Math.random() * (Date.now() - vibe.createdAt.getTime())
        ),
      });
...
async function updateVibesWithInteractions(
  users: any[],
  vibes: any[],
  comments: any[]
) {
  for (const vibe of vibes) {
    ...
    const vibeComments = comments.filter(
      (c) => c.vibeId.toString() === vibe._id.toString()
    );
